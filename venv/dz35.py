...
st3 = Student("Male", 22, "John", "Smith", "3")
st4 = Student("Male", 22, "Vasilii", "Petrov", "4")
st5 = Student("Male", 22, "Alexsey", "Ivanov", "5")
st6 = Student("Female", 22, "Alisa", "Smith", "6")
st7 = Student("Female", 22, "Natasha", "Jobs", "7")
st8 = Student("Male", 22, "Olga", "Pegalo", "8")
st9 = Student("Male", 22, "Valera", "Shpak", "9")
st10 = Student("Male", 22, "Victor", "Maksimov", "10")
st11 = Student("Male", 22, "Evgeniy", "Shkapypilo", "11")
